...
export const getOrderDetalisThunk = createAsyncThunk(
	"getOrderDetalisThunk",
	async (id) => {
		try {
...
const orderSlice = createSlice({
	...
	initialState: {
		shipingInfo: localStorage.getItem("shipingInfo")
			...
			: null,
		stripeClientKey: localStorage.getItem("stripeClientkey")
			? localStorage.getItem("stripeClientkey")
			: null,
		loading: false,
		orderId: null,
		userOrders: null,
...
export const { addShippingInfo, addStripeClientKey, changeOrderStatus } =
	orderSlice.actions;
