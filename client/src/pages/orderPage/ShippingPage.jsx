...
const ShippingPage = () => {
  ...
  return (
    <div className="mt-[100px]">
      ...
      <form className="px-6 max-w-[800px] mt-16 lg:mx-auto ">
              ...
              <div className="sm:col-span-3">
                ...
                <div className="mt-2">
                  <input
                    ...
                    className="block w-full rounded-md border-1 py-1.5 text-gray-900 shadow-sm ring-1 ring-inset ring-gray-300 placeholder:text-gray-400 focus:ring-2 focus:ring-offset focus:ring-[#ff6347] focus:border-none sm:text-sm sm:leading-6"
                  />
                </div>
              </div>
