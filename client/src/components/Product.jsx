...
const {name,price,images,_id}=product
	// console.log(product)
	return (
		<Link to={`/product/${_id}`}className="h-[350px] flex items-start  flex-col gap-3 rounded-xl font-['Poppins'] font-bold  pl-5 hover:-translate-y-3 transition-all duration-300 ease-out group">
